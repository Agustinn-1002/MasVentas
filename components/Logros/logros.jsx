              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className={["mt-6 space-y-3 flex md:flex-row flex-col md:justify-between", isRight ? " max-sm:justify-center md:flex-row-reverse" : "max-sm:justify-center"].join(" ")}>
                    <div className="md:flex md:space-x-2 text-sm max-sm:grid max-sm:grid-cols-2 max-sm:gap-y-2 max-sm:gap-x-10 text-center self-center">
                      {i.items.map(e => (
                        <div key={e} className="py-1 bg-white text-neutral-800 px-3 rounded-2xl" >
                          {e}
                        </div>
                      ))}
                    </div>
                    <button className=" items-center rounded-lg bg-white/80 px-3 py-1.5 text-sm font-semibold text-neutral-900 hover:bg-white">
                      Ver detalles
                    </button>
